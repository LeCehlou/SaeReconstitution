...
public class Controller_Importer_Ressource implements Initializable {
	...
	private final String styleMenuAndButtons = "/Version_Enseignant/FXML_Files/MenuAndButtonStyles.css";
	@FXML
	...
	@FXML
	public synchronized void importerRessource(ActionEvent event) throws IOException {
	...
	public void sliderVideoChange() {
		...
		mediaPlayer.setOnReady(()-> {Duration totalTemps = media.getDuration();progressBar.setMax(totalTemps.toSeconds());});
	...
	@FXML
	public synchronized void pageApercu(ActionEvent event) throws IOException {
	...
	public synchronized void darkMode() {
		...
		if(dark.isSelected()) {
			okImport.getScene().getStylesheets().removeAll(getClass().getResource(styleMenuAndButtons).toExternalForm());
			okImport.getScene().getStylesheets().addAll(getClass().getResource(styleMenuAndButtons).toExternalForm());
	...
	public void darkModeActivation(Scene scene) {
		if(Controller_Page_Accueil.isDark) {
			scene.getStylesheets().removeAll(getClass().getResource(styleMenuAndButtons).toExternalForm());
			...
			scene.getStylesheets().addAll(getClass().getResource(styleMenuAndButtons).toExternalForm());
